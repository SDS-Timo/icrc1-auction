export const idlFactory = ({ IDL }) => {
  ...
  return IDL.Service({
    ...
    getTrustedLedger: IDL.Func([], [IDL.Principal], ["query"]),
    ...
    manageOrders: IDL.Func(
      [IDL.Opt(CancellationArg), PlaceArg],
      [ManageOrdersResponse],
      []
    ),
    minimumOrder: IDL.Func([], [IDL.Nat], ["query"]),
    placeAsks: IDL.Func(
      [IDL.Vec(IDL.Tuple(Token, IDL.Nat, IDL.Float64))],
